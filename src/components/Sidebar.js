...
const Sidebar = forwardRef(({ isOpen }, setRef) => (
  <div
    ref={isOpen ? setRef : null}
    className={
      isOpen === undefined ? "d-none" : isOpen ? "wrapper" : "close-wrapper"
    }
  >
    <div className={isOpen ? "content p-5" : "content-close p-5"}>
      ...
      <div className={isOpen ? "card-section my-5" : "card-section-close my-5"}>
